...
Private Sub EdNomCopiar_Click()
    ...
    For i = ConNom1.Row To ConNom1.RowSel
        ...
        For j = ConNom1.Col To ConNom1.ColSel
            ' Si es la última columna seleccionada, añadir con comilla simple
...
Private Sub generarNominas()
    ...
    ' El código ahora intentará abrirlos directamente,
    ' y si falla, el 'ManejarError' lo ignorará.
...
' Si ocurre un error (como el 76), simplemente saltará
' a la siguiente línea de código sin mostrar alarma.
ManejarError:
    Resume Next
End Sub
