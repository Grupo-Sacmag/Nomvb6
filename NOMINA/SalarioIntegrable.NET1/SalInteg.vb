...
Friend Class SalInteg
    ...
    Dim name As String, PrTnes(50) As String
	Dim Z1 As String
	Sub CatCpt()
    ...
    Private Sub SalIn1_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalIn1.Enter
