...
Private Sub CapArch_Click(Index As Integer)
    ...
    For r1 = 1 To limite
      ...
      If Val(Clbnx.Q1) > 1 Then
         ...
         If vales = "" Then vales = 0
            Rem linimpte = ConNom1.TextMatrix(r1, 20) - vales
    ...
    For r1 = 1 To limite
     ...
     End If
      ...
      If plastico <> "01" Then
                 plastico = "03"
                 Rem antes 2013 :numsuc = "0000"
                 claveban = Clbnx.Q1
                 claveban = String(20 - Len(Trim(claveban)), "0") + claveban
                 Else
                 Rem antes de 2013 :numsuc = Left(Clbnx.Q1, punto)
      ...
      End If
      Rem linarch$ ="30001" + linimp$ + linca$ + plastico+ claveban
      Rem hasta ahi campo 01 al 45 ***********
      LINARCH$ = "30001" + linimp$ + linca$ + plastico + claveban + String(30, " ") + referencia$
      Rem cambio 2013 :linarch$ = linarch$ + "0000" + claveban + referencia$ + String(30, " ")
      Rem hasta ahi campo 01 al 85 ***********
      ...
      End If
      Rem hasta el nombre vamos en el campo 140
      If plastico = "01" Then
        LINARCH$ = LINARCH$ + nomban$ + "NOMINA" + String(34, " ") + "NOMINA" + String(18, " ") + String(4, "0") + String(6, "0") + "1" + "00"
        Rem hasta el nombre vamos en el                  campo 180                      campo 204 clabe campo 208 ref.bajo valor campo 215 mismo dia 217
        Else
      ...
      TREXC.Ex.AddItem Clbnx.Q1 & Chr(9) & Trim(personal.nom) & Chr(9) & Trim(personal.ape1) & Chr(9) & Trim(personal.ape2) _
                              & Chr(9) & Format(Impte_Tr, "#,##0.00") & Chr(9) & Format(rgtro, "####0") & Chr(9) & " " & Chr(9) & _
                                Mid(Label7.Caption, 1, 7) & Chr(9) & "Mismo dia" & Chr(9) & Format(Siguiente, "####0")
     ...
     For i1 = 1 To fin_A
      ...
      If fin = 1 Then
        ...
        If Option2 = False Then
                Rem Printer.Print "Percepciones : 1.Hs.Extras 2.Viaticos 3.P.vacacional 4.Otras 5.Vales Desp."
                Printer.Print "Percepciones : 1.Hs.Extras 2.Viaticos 3.P.vacacional 4.Otras 5.Perc.exenta."
                Else
                Rem Printer.Print "Percepciones :"; RTrim(Label7.Caption); " 2.Viaticos 3.P.vacacional 4.Otras 5.Vales Desp.."
...
Sub sumavert()
   ...
   li = limite + 1
    ...
    Next late
    Rem If IsNumeric(ConNom1.TextMatrix(li, 10)) Then si_hay = 1
    Rem  AQUI VAN LOS EXENTOS  *********************************
...
Sub carganom()
   ...
   ii = ii + 1: Rem 5
   Rem ***********************  AQUI VA EL AGUINALDO EN LUGAR DE HORAS EXTRAS DOBLES **********
   If N_ormal = 1 Then
   ...
   End If
   ii = ii + 1: Rem 6
   Rem  **********************  AQUI VA EL PTU EN LUGAR DE HORAS EXTRAS TRIPLES  *****************
   If N_ormal = 1 Then
   ...
   ii = ii + 1: Rem 18
   If nomina.otraded <> 0 Then ConNom1.TextMatrix(li, 18) = Format(nomina.otraded, z1$) Else ConNom1.TextMatrix(li, ii) = "": Rem ESTA ES INFONAVIT
   ii = ii + 1: Rem 19
...
Sub define()
   ...
   Rem ConNom1.Col = 10: ConNom1.CellAlignment = 4: ConNom1.ColWidth(10) = 1200: ConNom1.Text = "Vales Desp."
