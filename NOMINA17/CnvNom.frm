...
Sub carga()
      ...
      Rem Open Directorio + "personal.dno" For Random As 1 Len = Len(personal)
    ...
    For r = 1 To Wm: Get 7, r, NxF
           For g = 1 To CxNom.Rows - 1
               ...
               If CxNom.TextMatrix(g, 0) = NxF.Empleado Then
                  ...
                  Rem calculo Salario, impto, 1
                  Rem If impto > 0 Then
                        Rem CxNom.TextMatrix(g, 4) = Format(impto, z1)
                        Rem CxNom.TextMatrix(g, 5) = ""
                        Rem Else
                        Rem CxNom.TextMatrix(g, 4) = ""
                        Rem CxNom.TextMatrix(g, 5) = Format(impto, z1)
                  Rem End If
                  Exit For
               End If
           Next g
...
Private Sub Form_Load()
    ...
    Rem CxNom.Col = 4: CxNom.ColWidth(3) = 1500: CxNom.CellAlignment = 3: CxNom.Text = "Impuesto": CxNom.CellFontBold = True
    Rem CxNom.Col = 5: CxNom.ColWidth(3) = 1500: CxNom.CellAlignment = 3: CxNom.Text = "Subsidio": CxNom.CellFontBold = True
