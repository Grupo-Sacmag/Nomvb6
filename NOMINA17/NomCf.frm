...
Sub IniCols()
   ...
   Rem NomCfdi.Col = I7: NomCfdi.CellAlignment = 4: NomCfdi.ColWidth(I7) = 1200: NomCfdi.Text = Trim(DATcf.Concepto)
...
Private Sub Form_Load()
    ...
    For I7 = 1 To Form8.ConNom1.Rows - 2
         If IsNumeric(Form8.ConNom1.TextMatrix(I7, 0)) Then
             ...
             For I8 = 59 To 135: NomCfdi.TextMatrix(I7, (I8 - 1)) = Format(0, "###0.00"): Next I8 ' TITULOS
            ...
            Rem If IsNumeric(Form8.ConNom1.TextMatrix(I7, 10)) Then NomCfdi.TextMatrix(I7, 62) = Format(Form8.ConNom1.TextMatrix(I7, 10), "###0.00"):        Rem 63 P021EPrima vacacional
